jsPlumb.ready(function () {
    ...
    document.getElementById("check-button").addEventListener("click", function () {
        ...
        if (is_connected_1_3 && is_connected_4_7 && is_connected_5_7 && is_connected_6_9 && is_connected_8_12 && !unallowed_connection_present) {
...
function SetData()
{
console.log("radio button tap")
//document.getElementById("armature").value = document.getElementById("p").value;
if (document.getElementById("lap").checked)
{
console.log("lap");
document.getElementById("armature").value = document.getElementById("myinput").value;
} 
else
{
console.log("wave");
document.getElementById("armature").value = "2";
}
